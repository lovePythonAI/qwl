...
headers = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; '
                         ...
                         'like Gecko) Chrome/94.0.4606.71 '
                         'Safari/537.36'}
# 定义下载图片的函数
def load_images():
    tmp = 0
    page = 1
    while True:
        page_url = 'https://image.baidu.com/search/acjson?tn=resultjson_com&logid=10371129381236677678&ipn=rj&ct=201326592&is=&fp=result&fr=&word={}&queryWord={}&cl=2&lm=-1&ie=utf-8&oe=utf-8&adpicid=&st=&z=&ic=&hd=&latest=&copyright=&s=&se=&tab=&width=&height=&face=&istype=&qc=&nc=1&expermode=&nojc=&isAsync=&pn={}&rn=30&gsm=3c&1682846532783='.format(search, search, page * 30)
        # 获取网页内容
